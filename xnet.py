...
def model(input_shape=(256,256,1), classes=1, kernel_size = 3, filter_depth = (64,128,256,512,0), pretrained_weights = None):
    ...
    conv15 = Conv2D(classes, (1,1), activation="softmax")(concat14)
